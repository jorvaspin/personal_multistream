...
const SearchBox = () => {
  ...
  const clientId = process.env.REACT_APP_TWTICH_CLIENT_ID //twitch client ID
  const accessToken = process.env.REACT_APP_TWITCH_ACCESS_TOKEN //twitch access token
